            ...
            if(email.isNotEmpty() && password.isNotEmpty()){
                firebaseAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener{
                    if(it.isSuccessful){
                        ...
                        Toast.makeText(this, "Hesap mevcut değil",Toast.LENGTH_SHORT).show()

                    }
                }
            }
            else{
                Toast.makeText(this, "Lütfen tüm boş alanları doldurduğunuza emin olun",Toast.LENGTH_SHORT).show()
